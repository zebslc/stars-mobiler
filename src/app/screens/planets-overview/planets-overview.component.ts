      ...
      <div class="planets-grid">
        <div *ngFor="let planet of planets()" class="planet-card">
          ...
          <div class="planet-stats">
            ...
            <div class="stat-row">
              ...
              <span class="stat-value"
                ...
                {{ (planet.maxPopulation / 1000000).toFixed(1) }}M</span
              >
            </div>
            <div class="stat-row">
              <span class="stat-label">Habitability:</span>
              <span class="stat-value" [style.color]="habitabilityColor(planet)"
                >{{ habitability(planet) }}%</span
              >
            </div>
          </div>
          ...
          <div *ngIf="buildQueue(planet).length > 0" class="build-queue">
            ...
            <div
              *ngFor="let item of buildQueue(planet).slice(0, 3); let i = index"
              class="queue-item"
            >
            ...
            <div
              *ngIf="buildQueue(planet).length > 3"
          ...
          <div
            *ngIf="buildQueue(planet).length === 0"
