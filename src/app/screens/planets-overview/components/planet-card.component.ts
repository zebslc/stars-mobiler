  ...
  template: `
    <div class="planet-card">
      <div class="planet-header">
        <h3>{{ planet.name }}</h3>
        <button (click)="onJumpToPlanet()" class="btn-small">
          <svg
            width="16"
            height="16"
            viewBox="0 0 24 24"
      ...
      <div class="planet-stats">
        ...
        <div class="stat-row">
          ...
          <span class="stat-value">
            ...
            {{ (planet.maxPopulation / 1000000).toFixed(1) }}M
          </span>
        </div>
        <div class="stat-row">
          ...
          @for (item of buildQueue().slice(0, 3); track $index) {
            <div class="queue-item">
              ...
              <span class="queue-project">
                ...
                @if (item.isAuto) {
                  <span class="text-xs text-muted" style="font-style:italic">
                    (Auto)
                  </span>
                }
              </span>
...
export class PlanetCardComponent {
  ...
  @Output() jumpToPlanet = new EventEmitter<void>();
