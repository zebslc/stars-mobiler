...
@Component({
  ...
  styles: [
    `
      ...
      .tech-icon-small.driver-std::before { background-position: 0px -576px; }
      .tech-icon-small.driver-super::before { background-position: 0px -640px; }
      .tech-icon-small.driver-ultra::before { background-position: 0px -704px; }
      .tech-icon-small.weap-laser::before { background-position: 0px -768px; }
      ...
      .tech-icon-small.weap-bludgeon::before { background-position: 0px -1280px; }
      .tech-icon-small.weap-torp-alpha::before { background-position: 0px -1344px; }
      .tech-icon-small.weap-torp-rho::before { background-position: 0px -1408px; }
      .tech-icon-small.weap-torp-anti::before { background-position: 0px -1472px; }
      .tech-icon-small.weap-torp-omega::before { background-position: 0px -1536px; }
      .tech-icon-small.weap-bomb-lady::before { background-position: 0px -1600px; }
      .tech-icon-small.weap-bomb-smart::before { background-position: 0px -1664px; }
      .tech-icon-small.weap-bomb-neutron::before { background-position: 0px -1728px; }
      .tech-icon-small.weap-bomb-cherry::before { background-position: 0px -1792px; }
      .tech-icon-small.weap-bomb-annihilator::before { background-position: 0px -1856px; }
      .tech-icon-small.def-shield-mole::before { background-position: 0px -1920px; }
      .tech-icon-small.def-shield-cow::before { background-position: 0px -1984px; }
      .tech-icon-small.def-shield-wolf::before { background-position: 0px -2048px; }
      .tech-icon-small.def-shield-phase::before { background-position: 0px -2112px; }
      .tech-icon-small.def-shield-langston::before { background-position: 0px -2176px; }
      .tech-icon-small.def-armor-tri::before { background-position: 0px -2240px; }
      .tech-icon-small.def-armor-crob::before { background-position: 0px -2304px; }
      .tech-icon-small.def-armor-neu::before { background-position: 0px -2368px; }
      .tech-icon-small.def-armor-val::before { background-position: 0px -2432px; }
      .tech-icon-small.elec-comp-bat::before { background-position: 0px -2496px; }
      .tech-icon-small.elec-comp-cyber::before { background-position: 0px -2560px; }
      .tech-icon-small.elec-comp-nexus::before { background-position: 0px -2624px; }
      .tech-icon-small.elec-jammer-10::before { background-position: 0px -2688px; }
      .tech-icon-small.elec-jammer-20::before { background-position: 0px -2752px; }
      .tech-icon-small.elec-jammer-50::before { background-position: 0px -2816px; }
      .tech-icon-small.elec-cloak-stealth::before { background-position: 0px -2880px; }
      .tech-icon-small.elec-cloak-super::before { background-position: 0px -2944px; }
      .tech-icon-small.elec-capacitor::before { background-position: 0px -3008px; }
      .tech-icon-small.mech-fuel-tank::before { background-position: 0px -3072px; }
      .tech-icon-small.mech-super-tank::before { background-position: 0px -3136px; }
      .tech-icon-small.mech-colony-mod::before { background-position: 0px -3200px; }
      .tech-icon-small.mech-maneuver-jet::before { background-position: 0px -3264px; }
      .tech-icon-small.mech-overthruster::before { background-position: 0px -3328px; }
      .tech-icon-small.mech-robo-miner::before { background-position: 0px -3392px; }
      .tech-icon-small.mech-auto-miner::before { background-position: 0px -3456px; }
      .tech-icon-small.scan-viewer::before { background-position: 0px -3520px; }
      .tech-icon-small.scan-rhino::before { background-position: 0px -3584px; }
      .tech-icon-small.scan-mole::before { background-position: 0px -3648px; }
      .tech-icon-small.scan-possum::before { background-position: 0px -3712px; }
      .tech-icon-small.scan-snooper::before { background-position: 0px -3776px; }
      .tech-icon-small.scan-eagle::before { background-position: 0px -3840px; }
      .tech-icon-small.scan-peerless::before { background-position: 0px -3904px; }
      .tech-icon-small.orb-dock::before { background-position: 0px -3968px; }
      .tech-icon-small.orb-sensor::before { background-position: 0px -4032px; }
      .tech-icon-small.orb-shield::before { background-position: 0px -4096px; }
      .tech-icon-small.hull-freight-s::before { background-position: 0px -4160px; }
      .tech-icon-small.hull-freight-m::before { background-position: 0px -4224px; }
      .tech-icon-small.hull-freight-l::before { background-position: 0px -4288px; }
      .tech-icon-small.hull-freight-super::before { background-position: 0px -4352px; }
      .tech-icon-small.hull-scout::before { background-position: 0px -4416px; }
      .tech-icon-small.hull-frigate::before { background-position: 0px -4480px; }
      .tech-icon-small.hull-destroyer::before { background-position: 0px -4544px; }
      .tech-icon-small.hull-cruiser::before { background-position: 0px -4608px; }
      .tech-icon-small.hull-battle-cruiser::before { background-position: 0px -4672px; }
      .tech-icon-small.hull-battleship::before { background-position: 0px -4736px; }
      .tech-icon-small.hull-dreadnought::before { background-position: 0px -4800px; }
      .tech-icon-small.hull-privateer::before { background-position: 0px -4864px; }
      .tech-icon-small.hull-rogue::before { background-position: 0px -4928px; }
      .tech-icon-small.hull-galleon::before { background-position: 0px -4992px; }
      .tech-icon-small.hull-colony::before { background-position: 0px -5056px; }
      .tech-icon-small.hull-mini-bomber::before { background-position: 0px -5120px; }
      .tech-icon-small.hull-b17::before { background-position: 0px -5184px; }
      .tech-icon-small.hull-stealth-bomber::before { background-position: 0px -5248px; }
      .tech-icon-small.hull-b52::before { background-position: 0px -5312px; }
      .tech-icon-small.hull-midget-miner::before { background-position: 0px -5376px; }
      .tech-icon-small.hull-mini-miner::before { background-position: 0px -5440px; }
      .tech-icon-small.hull-ultra-miner::before { background-position: 0px -5504px; }
      .tech-icon-small.hull-sb-fort::before { background-position: 0px -5568px; }
      .tech-icon-small.hull-sb-station::before { background-position: 0px -5632px; }
