      ...
      <div class="stats-grid">
        ...
        @if (stats().power) {
          <div class="stat-item highlight">
            ...
            @if (countSig() > 1) { <span class="per-unit">({{ stats().power }})</span> }
          </div>
        }
        @if (stats().range) {
          <div class="stat-item">
        ...
        @if (stats().shield) {
          <div class="stat-item highlight">
            ...
            @if (countSig() > 1) { <span class="per-unit">({{ stats().shield }})</span> }
          </div>
        }
        @if (stats().armor) {
          <div class="stat-item highlight">
            ...
            @if (countSig() > 1) { <span class="per-unit">({{ stats().armor }})</span> }
          </div>
        }
        @if (stats().defense) {
          <div class="stat-item">
