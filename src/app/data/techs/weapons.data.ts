...
*/
  ...
  },
  {
    ...
    mass: 2,
    cost: { ironium: 2, boranium: 10, germanium: 0, resources: 400 },
    stats: { power: 16, range: 1, initiative: 10, minesweeping: 200, hitsAllTargets: true },
    description: 'This weapon hits all targets in range each time it is fired. This weapon what makes an excellent mine sweeper capable of sweeping 200 mines per year.',
  ...
  },
  {
    ...
    tech: { Energy: 5 },
    mass: 1,
    cost: { ironium: 0, boranium: 8, germanium: 0, resources: 750 },
  ...
  },
  {
    ...
    stats: { power: 82, range: 3, initiative: 14, shieldOnlyDamage: true },
