...
# --- ENGINES ---
$assets += @{ Name="eng-settler";    Source="techs02.png"; Col=0; Row=1 }
$assets += @{ Name="eng-mizer";      Source="techs02.png"; Col=1; Row=1 }
$assets += @{ Name="eng-long-hump";  Source="techs02.png"; Col=2; Row=1 }
$assets += @{ Name="eng-trans";      Source="techs02.png"; Col=4; Row=0 }
$assets += @{ Name="eng-ram";        Source="techs02.png"; Col=7; Row=0 }
$assets += @{ Name="eng-interspace"; Source="techs02.png"; Col=6; Row=1 }

# --- MISSING ENGINES (need coordinates) ---
# $assets += @{ Name="eng-quick-jump-5";              Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="eng-jump-hub-6";                Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="eng-alpha-drive-8";             Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="eng-trans-star-10";             Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="eng-sub-galactic-scoop";        Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="eng-trans-galactic-scoop";      Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="eng-trans-galactic-super-scoop"; Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="eng-trans-galactic-mizer-scoop"; Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="eng-galaxy-scoop";              Source="techs??.png"; Col=?; Row=? }

# --- STARGATES ---
$assets += @{ Name="gate-std";       Source="techs05.png"; Col=0; Row=0 }
$assets += @{ Name="gate-jump";      Source="techs05.png"; Col=1; Row=0 }
$assets += @{ Name="gate-any";       Source="techs05.png"; Col=2; Row=0 }

# --- MASS DRIVERS ---
$assets += @{ Name="driver-std";     Source="techs05.png"; Col=3; Row=0 }
$assets += @{ Name="driver-super";   Source="techs05.png"; Col=4; Row=0 }
$assets += @{ Name="driver-ultra";   Source="techs05.png"; Col=5; Row=0 }

# --- BEAM WEAPONS ---
$assets += @{ Name="weap-laser";     Source="techs02.png"; Col=4; Row=3 }
$assets += @{ Name="weap-xray";      Source="techs02.png"; Col=5; Row=3 }
$assets += @{ Name="weap-minigun";   Source="techs02.png"; Col=6; Row=3 }
$assets += @{ Name="weap-yakimora";  Source="techs02.png"; Col=7; Row=3 }
$assets += @{ Name="weap-disrupt";   Source="techs02.png"; Col=3; Row=3 }
$assets += @{ Name="weap-phasor";    Source="techs02.png"; Col=5; Row=2 }
$assets += @{ Name="weap-gatling";   Source="techs02.png"; Col=2; Row=3 }
$assets += @{ Name="weap-big-mutha"; Source="techs02.png"; Col=0; Row=3 }
$assets += @{ Name="weap-bludgeon";  Source="techs06.png"; Col=0; Row=1 }
...
# --- MISSING BOMBS (need coordinates) ---
# $assets += @{ Name="weap-bomb-conventional";     Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="weap-bomb-laser-guided";     Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="weap-bomb-proximity";        Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="weap-bomb-hush-a-boom";      Source="techs??.png"; Col=?; Row=? }
...
# $assets += @{ Name="def-armor-superlatanium";         Source="techs??.png"; Col=?; Row=? }
...
# $assets += @{ Name="scan-bat-scanner";              Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-dna-scanner";              Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-pick-pocket-scanner";      Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-chameleon-scanner";        Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-ferret-scanner";           Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-dolphin-scanner";          Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-gazelle-scanner";          Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-rna-scanner";              Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-cheetah-scanner";          Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="scan-elephant-scanner";         Source="techs??.png"; Col=?; Row=? }
# --- PLANETARY SCANNERS ---
...
# $assets += @{ Name="robo-miner-40";                 Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="anti-personnel-mine";           Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="heavy-structural-mine";         Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="super-speed-trap";              Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="robo-maxi-miner";               Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="robo-ultra-miner";              Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="robo-super-miner";              Source="techs??.png"; Col=?; Row=? }
#
# --- TERRAFORMING ---
# $assets += @{ Name="terraforming-1";                Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="terraforming-7";                Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="terraforming-10";               Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="terraforming-15";               Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="terraforming-20";               Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="terraforming-25";               Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="terraforming-30";               Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="total-terraforming-35";         Source="techs??.png"; Col=?; Row=? }
#
# --- PLANETARY DEFENSES ---
# $assets += @{ Name="planet-laser";                  Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-x-ray-laser";            Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-missile-battery";        Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-phaser-battery";         Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-disruptor";              Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-photon-torpedo";         Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-omega-torpedo";          Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-anti-matter-torpedo";    Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-neutron-blaster";        Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-genesis-device";         Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-smart-bomb";             Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-neutron-bomb";           Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-enriched-neutron-bomb";  Source="techs??.png"; Col=?; Row=? }
# $assets += @{ Name="planet-peerless-bomb";          Source="techs??.png"; Col=?; Row=? }
