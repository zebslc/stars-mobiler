...
Each computer running Stars! must use a unique serial number. Given this, the copy protection activates ONLY in the following situations: - When players using the same serial number submit turns created on two different computers . This includes submitting turns from networked computers sharing a serial number. If you want to submit turns from different machines on a network, each of those machines must have a - One person submits turns for two or more player positions from different computers that share the same Stars! serial number .
...
This is where you give detailed orders to This is your view of the universe. Use the your fleets and planets. Collapsible tiles scanner toolbar to select filters and display data and controls for the planet or overlays. Manipulate fleet routes and fleet under your command.

### Messages Selection Summary

This is where you receive yearly reports from far-flung fleets and planets and
